			...
			<div className='w-full max-w-md bg-background rounded-[3rem] p-10 shadow-2xl text-center space-y-8'>
				...
				{status === "loading" && (
					<div className='space-y-6'>
						<div className='bg-amber-500/10 w-fit p-4 rounded-3xl text-amber-600 mx-auto animate-spin'>
							<Loader2 size={48} strokeWidth={2.5} />
						</div>
						<h1 className='text-3xl font-black italic uppercase'>
							Verifying <span className='text-amber-600'>Account</span>
						</h1>
				...
				{status === "success" && (
					<div className='space-y-6'>
						<div className='bg-amber-500/10 w-fit p-4 rounded-3xl text-amber-600 mx-auto'>
